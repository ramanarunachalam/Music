...
function do_search() {
    ...
    var header = '<div class="card><div class="card-header"><h4 class="SONG_HEADER"><span><img class="ICON" src="icons/search.svg">&nbsp; Search Results</span></h4></div><div class="card-body"><ol>';
    var footer = '</ol></div></div>'
