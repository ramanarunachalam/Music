...
function play_first() {
    ...
    yt_player.loadVideoById({'videoId': parts[0]});
}
...
function search_load() {
    let url = 'search_index.json';
    let search_obj = $.getJSON(url, function(search_obj) {
        var data_id = 0;
...
function do_search(text) {
    ...
    let results = miniSearch.search(search_word, { prefix: true });
