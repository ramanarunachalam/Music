...
function show_playlist()
{
    ...
    {
        var audio_file = play_list[i].split('/');
        html_str += '<tr><td>' + (i + 1) + '</td><td>' + audio_file[3] + '</td><td>' + audio_file[4] + '</td><td>' + audio_file[5] + '</td><td><a href="#" onclick="delete_row(this);"><span class="glyphicon glyphicon-remove-circle"></span></a></td></tr>';
    }
    html_str += '</table>';
