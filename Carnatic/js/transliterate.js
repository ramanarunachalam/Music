...
let STAT_DICT = { 'Tamil' : { 'Videos' : 'வீடியோக்கள்', 'Ragas' : 'ராகங்கள்', 'Artists' : 'கலைஞர்கள்', 'Composers' : 'கவிஞர்கள்', 'Types' : 'வகைகள்', 'Songs' : 'பாடல்கள்', 'Duration' : 'காலம்', 'Views' : 'பார்வைகள்', 'Updated' : 'புதுப்பிக்கப்பட்டது' },
                  ...
                  'Malayalam' : { 'Videos' : 'വീഡിയോകൾ', 'Ragas' : 'രാഗങ്ങൾ', 'Artists' : 'കലാകാരന്മാർ', 'Composers' : 'കവികൾ ', 'Types' : 'തരങ്ങൾ', 'Songs' : 'ഗാനങ്ങൾ', 'Duration' : 'കാലാവധി', 'Views' : 'കാഴ്‌ചകൾ', 'Updated' : 'Updated' },
...
let INFO_DICT = { 'Tamil' : { 'Born' : 'பிறப்பு', 'Died' : 'இறப்பு', 'Melakartha' : 'மேளகர்த்தா', 'Arohanam' : 'ஆரோகணம்', 'Avarohanam' : 'அவரோகணம்', 'Tala' : 'தாளம்', 'Tala name' : 'தாள பெயர்', 'Tala angas' : 'தாள அங்கங்கள்', 'Tala count' : 'தாள எண்ணிக்கை', 'Language' :'மொழி', 'God' : 'இறைவன்', 'Tamil' : 'தமிழ்', 'Telugu' : 'தெலுங்கு', 'Kannada' : 'கன்னடா', 'Malayalam' : 'மலையாளம்', 'Sanskrit' : 'சமஸ்கிருதம்' },
                  'Telugu' : { 'Born' : 'పుట్టిన', 'Died' : 'మరణం', 'Melakartha' : 'మేళకర్త', 'Arohanam' : 'ఆరోహణ', 'Avarohanam' : 'అవరోహణ', 'Tala' : 'తాలా', 'Tala name' : 'తాలా పేరు ', 'Tala angas' : 'తాలా అంగస్', 'Tala count' : 'తాలా లెక్కింపు ', 'Language' :'భాష', 'God' : 'దేవుడు', 'Tamil' : 'తమిళం', 'Telugu' : 'తెలుగు', 'Kannada' : 'కన్నడ', 'Malayalam' : 'మలయాళం', 'Sanskrit' : 'సంస్కృత' },
                  'Kannada' : { 'Born' : 'ಜನನ', 'Died' : 'ಮರಣ', 'Melakartha' : 'ಮೇಳಕರ್ತ', 'Arohanam' : 'ಆರೋಹಣ', 'Avarohanam' : 'ಅವರೋಹಣ', 'Tala' : 'ತಲಾ', 'Tala name' : 'ತಲಾ ಹೆಸರು ', 'Tala angas' : 'ತಲಾ ಅಂಗಗಳು', 'Tala count' : 'ತಲಾ ಎಣಿಕೆ', 'Language' :'ಭಾಷೆ', 'God' : 'ದೇವರು', 'Tamil' : 'ತಮಿಳು', 'Telugu' : 'ತೆಲುಗು', 'Kannada' : 'ಕನ್ನಡ', 'Malayalam' : 'ಮಲಯಾಳಂ', 'Sanskrit' : 'ಸಂಸ್ಕೃತ' },
                  'Malayalam' : { 'Born' : 'ജനനം ', 'Died' : 'മരണം', 'Melakartha' : 'മേളകർത്താ', 'Arohanam' : 'ആരോഹണം', 'Avarohanam' : 'അവരോഹണം', 'Tala' : 'തലം', 'Tala name' : 'തലം പേര്', 'Tala angas' : 'തലം അംഗങ്ങൾ', 'Tala count' : 'തലം എണ്ണം', 'Language' :'ഭാഷ', 'God' : 'ദൈവം', 'Tamil' : 'തമിഴ് ', 'Telugu' : 'തെലുങ്ക്', 'Kannada' : 'കന്നഡ', 'Malayalam' : 'മലയാളം', 'Sanskrit' : 'സംസ്കൃതം ' },
                  'Sanskrit' : { 'Born' : 'जन्म', 'Died' : 'मरण', 'Melakartha' : 'मेलकर्ता', 'Arohanam' : 'आरोहण', 'Avarohanam' : 'अवरोही', 'Tala' : 'ताल', 'Tala name' : 'ताल नाम', 'Tala angas' : 'ताल आगा', 'Tala count' : 'ताल गिनती', 'Language' :'भाषा', 'God' : 'भगवान', 'Tamil' : 'तमिल', 'Telugu' : 'तेलुगु ', 'Kannada' : 'कन्नड़', 'Malayalam' : 'मलयालम', 'Sanskrit' : 'संस्कृत' },
                };
