...
function get_transliterator_text(category, data){
    ...
    if (scriptOutput == 'English') {
        let result = transliterate_map_text(lists_to_map([' jJ', '\tjJ', '\njJ', 'jJ', 'Jc', 'Jj', 'Mc', 
        'Mj', 'Mk', 'Mg',  'G', '_r', '_n', 'R', 'RR', 'lR', 'lRR', 'M'
        ], [' jn', '\tjn', '\njn', 'gy', 'nc', 'nj', 'nc', 'nj', 'nk', 'ng', 'n', 'R',  'n', 'ru',
         'rU', 'lu', 'lU', 'm']), data);
        return result;
    }
    var scriptOutput = scriptOutput.toLowerCase();
    let inlist = script_input_map.get(strip(scriptInput));
    let result = '';    
    if (strip(scriptInput) == 'harvardkyoto_tamil') { 
        if (strip(scriptOutput) == 'tamil') { 
            ...
            result =  transliterate_map_text(lists_to_map(harvardkyoto_expanded_list,
                script_output_map.get(strip(scriptOutput))), res); 
            if (strip(scriptOutput) == 'english') {
                result = transliterate_map_text(lists_to_map([' jJ', '\tjJ', '\njJ', 'jJ', 'Jc', 'Jj', 'Mc', 
                'Mj', 'Mk', 'Mg',  'G', '_r', '_n', 'R', 'RR', 'lR', 'lRR', 'M'
                ], [' jn', '\tjn', '\njn', 'gy', 'nc', 'nj', 'nc', 'nj', 'nk', 'ng', 'n', 'R',  'n', 'ru',
                 'rU', 'lu', 'lU', 'm']), result);
            }                                               
        ...
        if (strip(scriptOutput) == 'tamil') { 
            ...
            let outlist = script_output_map.get(strip(scriptOutput));                                    
